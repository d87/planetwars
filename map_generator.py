...
#modified map generator from Google AI Challenge
#now all plants are neutral on the map, server assigns them
...
def make_planet(x, y, owner, num_ships, growth_rate):
    ...
    return { "id" : ID, "x" : x, "y" : y, "owner" : 0, "num_ships" : num_ships,
            "growth_rate" : growth_rate}

def print_planet(p):
    out = ["P", p["id"],  p["x"], p["y"], p["growth_rate"], p["owner"], p["num_ships"] ]
